import { $R, Be, Fl, Hr, Je, Jt, Ln, O8, SO, Ss, Ua, Xt, Ze, _X, cn, dt, hi, kt, la, lt, sr, ti, tr, un, vh, xt } from "./index-e6Cke-ty-BIekTqkY.js";

//#region client/overview-DoRkU2w7.js
const U = {}, _ = {
	viewBox: "0 0 566 154",
	fill: "none",
...
const A = /* @__PURE__ */ $R(U, [["render", O]]), F = "8.0.3", $ = {
	...
	__name: "overview",
	setup(Z) {
		const { vueVersion: d } = Fl(), x = xt(1), p = xt(0);
		function b(i) {
			let t = 0;
			for (const f of i) t++, f.children?.length && (t += b(f.children));
			return t;
		}
		function T(i) {
		...
		return SO(() => {
			Xt.value.getRouterInfo().then((i) => {
				x.value = i?.routes?.length || 1;
			}), Xt.functions.on(Ln.ROUTER_INFO_UPDATED, T), Xt.value.getInspectorTree({
				inspectorId: "components",
				filter: ""
			}).then((i) => {
				p.value = b(ti(i));
			});
		}), Xt.functions.on(Ln.INSPECTOR_TREE_UPDATED, L), hi(() => {
			Xt.functions.off(Ln.INSPECTOR_TREE_UPDATED, L), Xt.functions.off(Ln.ROUTER_INFO_UPDATED, T);
		}), (i, t) => {
			const f = A, w = la("RouterLink");
			return Je(), lt("div", $, [Ze("div", h, [
				t[29] || (t[29] = Ze("div", { "flex-auto": "" }, null, -1)),
				Ze("div", K, [Ze("div", q, [dt(f, { "h-18": "" })]), Be(Ua) ? tr("", !0) : (Je(), lt("div", z, [t[0] || (t[0] = Ze("span", { op40: "" }, " Vue DevTools ", -1)), Ze("code", G, "v" + un(Be(F)), 1)]))]),
				Ze("div", W, [
					Ze("div", X, [t[1] || (t[1] = Ze("div", {
						"i-logos-vue": "",
						"text-3xl": ""
					}, null, -1)), Ze("code", null, "v" + un(Be(d)), 1)]),
					dt(w, {
						flex: "~ col auto",
						to: "/pages",
						replace: "",
						...
						default: kt(() => [t[2] || (t[2] = Ze("div", {
							"i-carbon-tree-view-alt": "",
							"text-3xl": ""
						}, null, -1)), Ze("div", null, un(Be(x)) + " pages", 1)]),
						_: 1
					}),
					Be(p) ? (Je(), Jt(w, {
						key: 0,
						...
						default: kt(() => [t[3] || (t[3] = Ze("div", {
							"i-carbon-assembly-cluster": "",
							"text-3xl": ""
						}, null, -1)), Ze("div", null, un(Be(p)) + " components", 1)]),
						_: 1
					})) : tr("", !0)
				]),
				Ze("div", Y, [
					t[5] || (t[5] = Ze("a", {
						...
						transition: ""
					}, [Ze("div", { "i-carbon-star": "" }), cn(" Star on GitHub ")], -1)),
					t[6] || (t[6] = Ze("a", {
						...
						transition: ""
					}, [Ze("div", { "i-carbon-data-enrichment": "" }), cn(" Ideas & Suggestions ")], -1)),
					t[7] || (t[7] = Ze("a", {
						...
						transition: ""
					}, [Ze("div", { "i-carbon-plan": "" }), cn(" Project Roadmap ")], -1)),
					t[8] || (t[8] = Ze("a", {
						...
						transition: ""
					}, [Ze("div", { "i-carbon-debug": "" }), cn(" Bug Reports ")], -1)),
					dt(w, {
						to: "/settings",
						flex: "~ gap1",
						replace: "",
						...
						default: kt(() => [...t[4] || (t[4] = [Ze("div", { "i-carbon-settings": "" }, null, -1), cn(" Settings ", -1)])]),
						_: 1
					})
				]),
				t[30] || (t[30] = Ze("div", { "flex-auto": "" }, null, -1)),
				Ze("div", J, [
					t[15] || (t[15] = cn(" Press ", -1)),
					Be(_X)() ? (Je(), lt(Hr, { key: 0 }, [
						dt(Be(Ss), null, {
							default: kt(() => [...t[9] || (t[9] = [cn(" ⌘ Command ", -1)])]),
							_: 1
						}),
						t[11] || (t[11] = Ze("span", null, "+", -1)),
						dt(Be(Ss), null, {
							default: kt(() => [...t[10] || (t[10] = [cn(" K ", -1)])]),
							_: 1
						})
					], 64)) : (Je(), lt(Hr, { key: 1 }, [
						dt(Be(Ss), null, {
							default: kt(() => [...t[12] || (t[12] = [cn(" Alt ", -1)])]),
							_: 1
						}),
						t[14] || (t[14] = Ze("span", null, "+", -1)),
						dt(Be(Ss), null, {
							default: kt(() => [...t[13] || (t[13] = [cn(" K ", -1)])]),
							_: 1
						})
					], 64)),
					t[16] || (t[16] = cn(" to toggle Command Palette ", -1))
				]),
				!Be(vh) && !Be(Ua) ? (Je(), lt("div", Q, [
					t[27] || (t[27] = cn(" Press ", -1)),
					Be(_X)() ? (Je(), lt(Hr, { key: 0 }, [
						dt(Be(Ss), null, {
							default: kt(() => [...t[17] || (t[17] = [cn(" ⇧ Shift ", -1)])]),
							_: 1
						}),
						t[20] || (t[20] = Ze("span", null, "+", -1)),
						dt(Be(Ss), null, {
							default: kt(() => [...t[18] || (t[18] = [cn(" ⌥ Option ", -1)])]),
							_: 1
						}),
						t[21] || (t[21] = Ze("span", null, "+", -1)),
						dt(Be(Ss), null, {
							default: kt(() => [...t[19] || (t[19] = [cn(" D ", -1)])]),
							_: 1
						})
					], 64)) : (Je(), lt(Hr, { key: 1 }, [
						dt(Be(Ss), null, {
							default: kt(() => [...t[22] || (t[22] = [cn(" Shift ", -1)])]),
							_: 1
						}),
						t[25] || (t[25] = Ze("span", null, "+", -1)),
						dt(Be(Ss), null, {
							default: kt(() => [...t[23] || (t[23] = [cn(" Alt ", -1)])]),
							_: 1
						}),
						t[26] || (t[26] = Ze("span", null, "+", -1)),
						dt(Be(Ss), null, {
							default: kt(() => [...t[24] || (t[24] = [cn(" D ", -1)])]),
							_: 1
						})
					], 64)),
					t[28] || (t[28] = cn(" to toggle DevTools ", -1))
				])) : tr("", !0)
			])]);
		};
	}
